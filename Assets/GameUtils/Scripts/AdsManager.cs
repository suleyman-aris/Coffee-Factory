...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class AdsManager : BaseManager {
            ...
            public enum RewardedResetDelayOverride {
                NoOverride,
                True,
                False
            }
            ...
            [HideInInspector] public RewardedResetDelayOverride rewardedResetDelayOverride = RewardedResetDelayOverride.NoOverride;
            ...
            public void InitializeRewardedAds() {
                if (this.GetRewardedKey() != "") {
                    ...
                    MaxSdkCallbacks.Rewarded.OnAdHiddenEvent += (string adUnitId, MaxSdkBase.AdInfo adInfo) => {
                        ...
                        if (this.ycManager.ycConfig.rewardedResetDelay || this.rewardedResetDelayOverride == RewardedResetDelayOverride.True) {
